...
ccndelphi: ccndelphi.o
	$(CC) $(CFLAGS) -o $@ ccndelphi.o $(LDLIBS) $(OPENSSL_LIBS) -lcrypto

ccntraffic: ccntraffic.o
	$(CC) $(CFLAGS) -o $@ ccntraffic.o $(LDLIBS) $(OPENSSL_LIBS) -lcrypto
...
ccndelphi.o: ccndelphi.c ../include/ccn/ccn.h \
  ../include/ccn/coding.h ../include/ccn/charbuf.h \
  ../include/ccn/indexbuf.h ../include/ccn/uri.h \
  ../include/ccn/keystore.h ../include/ccn/signing.h
ccntraffic.o: ccntraffic.c ../include/ccn/ccn.h \
  ../include/ccn/coding.h ../include/ccn/charbuf.h \
  ../include/ccn/indexbuf.h ../include/ccn/uri.h \
